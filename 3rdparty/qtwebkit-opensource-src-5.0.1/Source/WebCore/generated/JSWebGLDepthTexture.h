...
public:
    ...
    {
        JSWebGLDepthTexture* ptr = new (NotNull, JSC::allocateCell<JSWebGLDepthTexture>(globalObject->globalData().heap)) JSWebGLDepthTexture(structure, globalObject, impl);
...
public:
    ...
    static JSWebGLDepthTexturePrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSWebGLDepthTexturePrototype* ptr = new (NotNull, JSC::allocateCell<JSWebGLDepthTexturePrototype>(globalData.heap)) JSWebGLDepthTexturePrototype(globalData, globalObject, structure);
...
private:
    JSWebGLDepthTexturePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
