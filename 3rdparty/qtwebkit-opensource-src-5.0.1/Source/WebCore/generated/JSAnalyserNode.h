...
public:
    ...
    {
        JSAnalyserNode* ptr = new (NotNull, JSC::allocateCell<JSAnalyserNode>(globalObject->globalData().heap)) JSAnalyserNode(structure, globalObject, impl);
...
public:
    ...
    static JSAnalyserNodePrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSAnalyserNodePrototype* ptr = new (NotNull, JSC::allocateCell<JSAnalyserNodePrototype>(globalData.heap)) JSAnalyserNodePrototype(globalData, globalObject, structure);
...
private:
    JSAnalyserNodePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
...
public:
    ...
    static JSAnalyserNodeConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSAnalyserNodeConstructor* ptr = new (NotNull, JSC::allocateCell<JSAnalyserNodeConstructor>(*exec->heap())) JSAnalyserNodeConstructor(structure, globalObject);
