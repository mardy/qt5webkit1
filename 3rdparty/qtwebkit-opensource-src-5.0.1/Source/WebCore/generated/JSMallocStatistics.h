...
public:
    ...
    {
        JSMallocStatistics* ptr = new (NotNull, JSC::allocateCell<JSMallocStatistics>(globalObject->globalData().heap)) JSMallocStatistics(structure, globalObject, impl);
...
public:
    ...
    static JSMallocStatisticsPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSMallocStatisticsPrototype* ptr = new (NotNull, JSC::allocateCell<JSMallocStatisticsPrototype>(globalData.heap)) JSMallocStatisticsPrototype(globalData, globalObject, structure);
...
private:
    JSMallocStatisticsPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
