...
public:
    ...
    {
        JSGainNode* ptr = new (NotNull, JSC::allocateCell<JSGainNode>(globalObject->globalData().heap)) JSGainNode(structure, globalObject, impl);
...
public:
    ...
    static JSGainNodePrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSGainNodePrototype* ptr = new (NotNull, JSC::allocateCell<JSGainNodePrototype>(globalData.heap)) JSGainNodePrototype(globalData, globalObject, structure);
...
private:
    JSGainNodePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
