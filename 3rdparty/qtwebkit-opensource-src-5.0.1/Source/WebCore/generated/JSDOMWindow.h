...
JSC::JSValue jsDOMWindowOrientation(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
...
JSC::JSValue jsDOMWindowOnorientationchange(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
