...
public:
    ...
    {
        JSHTMLDialogElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLDialogElement>(globalObject->globalData().heap)) JSHTMLDialogElement(structure, globalObject, impl);
...
public:
    ...
    static JSHTMLDialogElementPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSHTMLDialogElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLDialogElementPrototype>(globalData.heap)) JSHTMLDialogElementPrototype(globalData, globalObject, structure);
...
private:
    JSHTMLDialogElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
