...
public:
    ...
    {
        JSPerformanceEntry* ptr = new (NotNull, JSC::allocateCell<JSPerformanceEntry>(globalObject->globalData().heap)) JSPerformanceEntry(structure, globalObject, impl);
...
public:
    ...
    static JSPerformanceEntryPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSPerformanceEntryPrototype* ptr = new (NotNull, JSC::allocateCell<JSPerformanceEntryPrototype>(globalData.heap)) JSPerformanceEntryPrototype(globalData, globalObject, structure);
...
private:
    JSPerformanceEntryPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
