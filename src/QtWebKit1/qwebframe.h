...
#ifndef QTWEBKIT1_QWEBFRAME_H
#define QTWEBKIT1_QWEBFRAME_H
...
class QTWEBKIT1_EXPORT QWebHitTestResult {
public:
    QWebHitTestResult();
...
class QTWEBKIT1_EXPORT QWebFrame : public QObject {
    Q_OBJECT
