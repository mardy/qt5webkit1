...
#ifndef QTWEBKIT1_QWEBPAGE_H
#define QTWEBKIT1_QWEBPAGE_H
...
class QTWEBKIT1_EXPORT QWebPage : public QObject {
    Q_OBJECT
...
public:
    ...
    class QTWEBKIT1_EXPORT ViewportAttributes {
    public:
        ViewportAttributes();
...
private:
    ...
    friend class QtWebKit1::QQuickWebView;
    friend class QtWebKit1::QQuickWebViewPrivate;
